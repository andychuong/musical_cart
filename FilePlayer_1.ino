 ...
 */
void loop() {
//This is what Victoria and I coded...it doesn't mess with the other commands cause those are nice and this is what one of the TA's told us to do
  Serial.print(analogRead(A0));
  analogRead(A0);
  if (analogRead(A0) < 305) // add pressure sensor code here
  {
    MP3player.stopTrack();
  }
...
if(FSRReading > 1000) {
digitalWrite(LED_BUILTIN, HIGH); //change to music
}
else{
  digitalWrite(LED_BUILTIN, LOW); / ll
}
